...
const updateClientes = async (req,res) => {
  ...
  try{
    ...
    await db.none(
      "UPDATE clientes SET nome = $1, cpf_cnpj = $2, email = $3, data_nascimento = $4, comentario = $5, tipo_pessoa = $6, telefone1 = $7, telefone2 = $8, endereco_logradouro = $9, endereco_numero = $10, endereco_complemento = $11, endereco_bairro = $12, endereco_cidade = $13, endereco_uf = $14, endereco_cep = $15 WHERE codigo = $16;"
    ...
    return res.status(500).send({ error: 'Erro ao atualizar cliente.', details: err.message });
  }
}
